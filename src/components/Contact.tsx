      ...
      <div className="container">
        ...
        >
          ...
          <p style={{ fontSize: 16, color: 'var(--text-muted)', lineHeight: 1.7, marginBottom: 40 }}>
            Open to full-time roles, contract work, and interesting problems. I reply to all emails.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap', marginBottom: 48 }}>
            {[
              ...
              {
                href: data.social.github, label: 'GitHub', primary: false,
                icon: (
              ...
              {
                href: data.social.linkedin, label: 'LinkedIn', primary: false,
                icon: (
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              ...
              <motion.a
                ...
                rel={btn.primary ? undefined : 'noreferrer'}
